        ...
        <div>
            <div className="mx-20 my-10">
                <div className="flex xl:flex-row flex-col lg:flex-row">
                    ...
                    <div className='mt-20 md:w-1/2 w-full pl-2'>
                        ...
                        <h3 className='text-xl md:text-3xl font-semibold text-teal-600 py-2'>My expertise:</h3>
                        <div className='grid grid-cols-1 md:grid-cols-2'>
                            <div className='flex my-2'>

                                <h4 className='px-2 mt-0.5 text-lg md:text-2xl'><FcBriefcase /></h4> <h4 className='text-md md:text-xl'>08 Years of Experiences</h4>
                            </div>
                            <div className='flex my-2'>

                                <h4 className='px-2 mt-0.5 text-lg md:text-2xl'><RiUserHeartFill /></h4> <h4 className='text-md md:text-xl'>1000+ Satisfied Clients</h4>
                            </div>
                            <div className='flex my-2'>

                                <h4 className='px-2 mt-0.5 text-lg md:text-2xl'><FaMapMarkedAlt /></h4> <h4 className='text-md md:text-xl'>30 Locations Covered</h4>
                            </div>
                            <div className='flex my-2'>

                                <h4 className='px-2 mt-0.5 text-lg md:text-2xl'><FcRating /></h4> <h4 className='text-md md:text-xl'>20+ Five Star Ratings</h4>
                            </div>
                    ...
                    <div className='invisible md:visible w-1/2'>
